...
function useDisableEvent(onEvent, disabled) {
  return _NREUHWTUcjs.useEvent.call(void 0, (event) => {
...
var useFocusable = _7NAIPZYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      focusable = true,
    ...
    const onFocusCapture = _NREUHWTUcjs.useEvent.call(void 0, (event) => {
    ...
    const autoFocusRef = _NREUHWTUcjs.useEvent.call(void 0, (element) => {
      if (!focusable)
        return;
      if (!autoFocus)
        return;
    ...
    const style = trulyDisabled ? _6455U47Tcjs.__spreadValues.call(void 0, { pointerEvents: "none" }, props.style) : props.style;
    props = _6455U47Tcjs.__spreadProps.call(void 0, _6455U47Tcjs.__spreadValues.call(void 0, {
      ...
      ref: _NREUHWTUcjs.useForkRef.call(void 0, ref, autoFocusRef, props.ref),
      style,
...
var Focusable = _7NAIPZYNcjs.createComponent.call(void 0, (props) => {
