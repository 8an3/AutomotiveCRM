...
function useEventOutside({
  ...
  const callListener = _NREUHWTUcjs.useEvent.call(void 0, listener);
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const onEvent = (event) => {
      ...
      if (isMouseEventOnDialog(event, contentElement))
        return;
      if (!_CARNFZQTcjs.isElementMarked.call(void 0, target, contentElement.id))
        return;
      callListener(event);
    };
...
function useHideOnInteractOutside(store, hideOnInteractOutside) {
  ...
  useEventOutside(_6455U47Tcjs.__spreadProps.call(void 0, _6455U47Tcjs.__spreadValues.call(void 0, {}, props), {
    type: "click",
    listener: (event) => {
      ...
      if (!_dom.isVisible.call(void 0, previousMouseDown))
        return;
      if (!_CARNFZQTcjs.isElementMarked.call(void 0, previousMouseDown, contentElement == null ? void 0 : contentElement.id))
        return;
