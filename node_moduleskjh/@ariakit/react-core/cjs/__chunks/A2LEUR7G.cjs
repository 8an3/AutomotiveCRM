...
var useCompositeContainer = _7NAIPZYNcjs.createHook.call(void 0, 
  (_a) => {
    ...
    const renderedItems = _F7HVNVHQcjs.useStoreState.call(void 0, store, "renderedItems");
...
var CompositeContainer = _7NAIPZYNcjs.createMemoComponent.call(void 0, (props) => {
