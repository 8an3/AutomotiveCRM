 ...
 * @category Guard
 */
export declare function isDeepEqual<T, S extends T>(other: S): (data: T) => data is S;
export declare function isDeepEqual<T, S extends T = T>(other: T extends Exclude<T, S> ? S : never): (data: T) => boolean;
