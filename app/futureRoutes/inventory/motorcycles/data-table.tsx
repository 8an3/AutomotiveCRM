   ...
   *
        ...
        <DropdownMenu>
            <DropdownMenuTrigger >
              ...
              <Button name='intent' value='2DaysFromNow' type='submit' className="bg-[#02a9ff] cursor-pointer text-slate1 mr-1 text-white active:bg-black font-bold uppercase   text-xs  rounded shadow hover:shadow-md outline-none focus:outline-none  ease-linear transition-all text-center duration-150">
                Default Filters
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="bg-slate12">
              <DropdownMenuLabel className="text-slate1 bg-slate12">Calls</DropdownMenuLabel>
              {CallsList.map((item) => (
                <DropdownMenuCheckboxItem
                  key={item.key}
                  name={item.name}
                  className="bg-slate12 capitalize cursor-pointer text-slate1 hover:underline hover:text-[#02a9ff] hover:text-[#02a9ff] "
              ...
              <DropdownMenuLabel className="text-slate1">Deliveries</DropdownMenuLabel>
              ...
              <DropdownMenuLabel className="text-slate1">Deposit Taken</DropdownMenuLabel>
            ...
            <DropdownMenuTrigger asChild>
              <Button name='intent' value='2DaysFromNow' type='submit'
                className="bg-[#02a9ff]  cursor-pointer  mx-1 text-white active:bg-black font-bold uppercase  my-auto text-xs  rounded shadow hover:shadow-md outline-none focus:outline-none  ease-linear transition-all text-center duration-150"
              >
                Global Filter
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="bg-slate12 bg-slate12 capitalize cursor-pointer  text-slate1 hover:underline hover:text-[#02a9ff]">
