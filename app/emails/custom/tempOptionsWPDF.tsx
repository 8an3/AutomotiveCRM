...
const TempOptionsWPDF = ({
	discount, discountPer, brand, url,customContent,biweekly,
  monthly, painPrem, model2,  weekly,
	userAirTax, userDemo, userMarketAdj, dealer, userGasOnDel, destinationCharge, userFinance, userGovern, userTireTax, onTax, total, months, stockNum, year, deposit, licensing, labour, accessories, msrp, tradeValue, model, modelCode, customerName, model1, userEmail, userPhone, qcTax, userFname, weeklyqc, biweeklyqc, qc60, pdi, admin, commodity, userServicespkg, vinE, rustProofing, userGap, userLoanProt, userTireandRim, userOther, userExtWarr,
}: ContactMeEmailProps) => {
...
export default TempOptionsWPDF;
