...
const EmailContent = (model, customerName, userPhone, userEmail) => {
    return (
        <>
            ...
            <Text style={paragraph}>
                I hope this message finds you well. I wanted to express my appreciation for the opportunity to meet with you and discuss your upcoming purchase of the {model}. It was a pleasure learning about your preferences and requirements.
            </Text>
            <Text style={paragraph}>
                As promised, I have attached the pricing details for the {model} to this email. Please review the payments below, and if you have any questions or need further information, do not hesitate to reach out.
            </Text>
            <Text style={paragraph}>
