...
export function Column({ name, columnId, items }: ColumnProps) {
  ...
  return (
    <div
      className={
        "flex-shrink-0 flex flex-col overflow-hidden max-h-full w-[250px] border-border rounded-[6px] shadow-sm shadow-muted-background bg-secondary items-center " +
      ...
      {edit ? (
        ...
        <div className="p-2 pt-1">
          <Button
            ...
            className="flex items-center gap-2 rounded-lg text-center w-full p-2 font-medium text-foreground hover:bg-slate-200 focus:bg-slate-200"
          >
