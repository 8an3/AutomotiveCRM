          ...
          <li key={item.to}>
            <Link
              ...
              className={cn(
                ...
                {
                  'bg-[#232324] hover:bg-[#232324] w-[90%]': pathname === item.to,
                  'hover:bg-[#232324]': pathname !== item.to,
                }
              )}
            >
              {item.title}
  ...
  return (
    <>
      <Sheet >
        ...
        <SheetContent side='right' className='bg-[#09090b] w-full md:w-[50%] overflow-y-auto' >
          ...
          <Tabs defaultValue="User" className="w-full">
            ...
            <TabsContent value="MY23">
              <>
                <ul className="menu bg-[#09090b] w-56 rounded-box">
                  <li>
                    <details open>
            ...
            <TabsContent value="MY24">
              <ul className="menu bg-[#09090b]  w-full rounded-box">
                <li>
                  <details open>
                    <summary>WATERCRAFT</summary>
                    <ul>
