      ...
      <div className="flex items-center py-4 justify-between">
        <div className='flex items-center'>
          <div className="relative mt-3">
            <Input
              value={globalFilter ?? ''}
              onChange={event => setGlobalFilter(event.target.value)} className="font-lg border-border w-[250px] border   bg-background p-2 text-foreground shadow"
            />
          ...
          <DialogContent className="sm:max-w-[425px] bg-background border-border text-foreground">
            ...
            <Form method='post' className="grid gap-4 py-4">
              ...
              <Button onClick={() => toast.success(`Added to Demo Day list!`)}
                type='submit' name='intent' value='addDemoDay' variant='outline' className="active:bg-background w-[75px] mt-10 mx-2 my-auto h-7  cursor-pointer rounded bg-primary px-3 py-2  text-center text-xs  font-bold  text-foreground shadow outline-none  transition-all duration-150 ease-linear hover:border-primary border-border hover:text-primary hover:shadow-md focus:outline-none"
              >
                Save
              </Button>
            </Form>
