  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant='outline' className="active:bg-black mx-auto my-auto h-7  cursor-pointer rounded bg-background px-3 py-2  text-center text-xs  font-bold uppercase text-foreground shadow outline-none  transition-all duration-150 ease-linear hover:border-primary  hover:text-primary hover:shadow-md focus:outline-none"
        >
          Edit
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px] bg-[#fff]">
        ...
        <Form method='post' className="grid gap-4 py-4">
          ...
          <Button onClick={() => toast.success(`Edited wishlist entry!`)}
            type='submit' name='intent' value='editWishList' variant='outline' className="active:bg-black w-[75px] mt-10 mx-2 my-auto h-7  cursor-pointer rounded bg-background px-3 py-2  text-center text-xs  font-bold uppercase text-foreground shadow outline-none  transition-all duration-150 ease-linear hover:border-primary  hover:text-primary hover:shadow-md focus:outline-none"
          >
            Save
          </Button>
        </Form>
