...
import { MoveLeft, MoveRight, FilterList, SortUp, SortDown, AddDatabaseScript, MailIn, InputField, MoneySquare, Map } from "iconoir-react";
                    ...
                    <div>
                      ...
                      >
                        {{
                          asc: <SortUp />,
                          desc: <SortDown />,
                        }[header.column.getIsSorted() as string] ?? <FilterList height='20' />}
                      </button>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        {{
                          asc: <SortUp />,
                          desc: <SortDown />,
                        }[header.column.getIsSorted() as string] ?? <FilterList />}
                      </button>
                    </div>
                    {header.column.getCanFilter() ? (
                      <div>
