...
export default function Example() {
  ...
  /**
   ...
   <select
                  ...
                  className={`border-black text-black placeholder:text-blue-300 broder mx-auto h-8  cursor-pointer rounded border bg-slate12 px-2 text-xs uppercase shadow transition-all duration-150 ease-linear focus:outline-none focus:ring focus-visible:ring-[#60b9fd]`}>
                ...
                <select className={`border-black text-black placeholder:text-blue-300 broder mx-auto ml-2  h-8 cursor-pointer rounded border bg-slate12 px-2 text-xs uppercase shadow transition-all duration-150 ease-linear focus:outline-none focus:ring focus-visible:ring-[#60b9fd]`}
                          ...
                          <div className="py-1">
                            <div className='flex flex-row justify-between'>
                              <select name='Select a Dept' defaultValue={item.dept}
                                className={`border-black text-black placeholder:text-blue-300 broder  h-8 cursor-pointer  justifty-start rounded border bg-slate12  px-2 text-xs uppercase shadow transition-all duration-150 ease-linear focus:outline-none focus:ring focus-visible:ring-[#60b9fd]`}>
                ...
                <div className="py-1">
                  <div className='flex flex-row justify-between'>
                    <select placeholder='Select a Dept'
                      name='dept'
                      className={`border-black text-black placeholder:text-blue-300 broder  h-8 cursor-pointer w-1/2 mr-2 justifty-start rounded border bg-slate12  px-2 text-xs uppercase shadow transition-all duration-150 ease-linear focus:outline-none focus:ring focus-visible:ring-[#60b9fd]`}>
                      <option value="">Select a Dept</option>
                      <option value="Active">Sales</option>
                      <option value="Duplicate">Service</option>
                      <option value="Invalid">Accessories</option>
