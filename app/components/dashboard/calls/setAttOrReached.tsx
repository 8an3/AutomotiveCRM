    ...
    <Form method="post" ref={formRef}>
      <div  >
        <select name='customerState'
          ...
          className="mx-auto  cursor-pointer px-2 py-1 rounded-md border border-white text-foreground h-8  bg-[#363a3f]  text-xs  placeholder-blue-300 shadow transition-all duration-150 ease-linear focus:outline-none focus:ring focus-visible:ring-[#60b9fd]"
        >
