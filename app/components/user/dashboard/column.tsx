...
export function Column({ name, columnId, items }: ColumnProps) {
  ...
  return (
    <div
      className={
        "flex-shrink-0 flex flex-col overflow-hidden max-h-full w-80   shadow-sm shadow-slate-400 bg-background border border-border p-4 rounded-[6px]" +
