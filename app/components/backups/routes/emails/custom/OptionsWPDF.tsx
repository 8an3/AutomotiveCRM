...
const OptionsWSpec = ({
	discount, discountPer, brand, url, customContent, painPrem, model2, userAirTax, userDemo, userMarketAdj, dealer, userGasOnDel, destinationCharge, userFinance, userGovern, userTireTax, onTax, total, months, stockNum, year, deposit, licensing, labour, accessories, msrp, tradeValue, model, modelCode, customerName, model1, userEmail, userPhone, qcTax, userFname, weekly, biweekly, monthly, pdi, admin, commodity, userServicespkg, vinE, rustProofing, userGap, userLoanProt, userTireandRim, userOther, userExtWarr,
}: ContactMeEmailProps) => {
