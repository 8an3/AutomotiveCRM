      ...
      <div className="mx-auto max-w-2xl py-[55px] ">
        ...
        <div className="text-center">
          ...
          <Form method="post" action="/emails/send/contact" className='mt-5 flex items-center  justify-center'>
            ...
            <Button name='intent' value='demoInquiry' type='submit' className=" ml-2 mr-2 w-[75px]  rounded bg-primary  text-center text-xs font-bold   uppercase  text-foreground shadow outline-none transition-all duration-150  ease-linear hover:shadow-md focus:outline-none active:bg-black"
            >
              Email
            </Button>
          </Form>
  ...
  return (
    <>
      ...
      <div className='mx-auto mb-[100px] mt-10 grid grid-cols-1 items-center text-center' >
        <h2 className="mx-auto text-center font-sans text-3xl font-bold text-foreground sm:mt-0 sm:text-4xl">
          Subscription Plan
        </h2>
        ...
        <a href='https://buy.stripe.com/14k6pTg9J0IV0G4fYZ' target="_blank">
          <Button type="submit" name='_action' value='subscribe' variant='outline' className=' mx-auto my-2 border-slate1 text-foreground' >
            Subscribe Now
          </Button>
        </a>
      </div>
      ...
      <Card className='mx-auto w-[90%] border-black'>
        <CardContent>
          ...
          <div className=' mx-auto mb-[50px] text-center'>
            ...
            <p className="m-auto mt-5 text-left text-foreground">
              ...
              <div className="p-1">
                <Card className='h-auto border-slate1'>
                  ...
                  <CardContent className="flex  justify-center rounded-md  bg-myColor-900 p-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-semibold text-foreground">{item.question}</h2>
                      <hr className='mb-3 text-foreground' />
    ...
    <>
      ...
      {sales === false && dealer === false && (
        <div className='mx-auto grid grid-cols-2 justify-center mb-[40px]  mt-[75px]'>
          ...
          <div className='p-1 mx-auto h-[900px] w-[550px] rounded-md border border-white cursor-pointer hover:border-primary' onClick={() => {
            setSales(true)
          }}>
            <h1 className='mt-[40px] text-center text-foreground  bold text-4xl'>Sales People</h1>
          ...
          <div className='p4 mx-auto h-[900px] w-[550px] cursor-pointer   rounded-md border border-white text-foreground hover:border-primary'
            onClick={() => {
              setDealer(true)
            }}>
            <h1 className='mt-[40px] text-center text-foreground  bold text-4xl'>For Dealers</h1>
            <div className="text-center">
