      ...
      <div className=" mx-auto mb-[5px] mt-10">
        <div className="flex h-[98vh] w-[98w] mx-auto  justify-center ">
          <div className="w-1/3 h-[100%] border border-[#ffffff4d] grid grid-cols-1 space-y-2">
            ...
            <div className="flex">
              <select
                className={`border-white text-[#fff] placeholder:text-blue-300  mx-auto ml-2  h-8 cursor-pointer rounded border bg-[#363a3f] px-2 text-xs uppercase shadow transition-all duration-150 ease-linear focus:outline-none focus:ring focus-visible:ring-primary`}
                value={selectedType}
              ...
              <select
                ...
                className={`border-white text-[#fff] placeholder:text-blue-300 broder mx-auto ml-2 h-8  cursor-pointer rounded border bg-[#363a3f] px-2 text-xs uppercase shadow transition-all duration-150 ease-linear focus:outline-none focus:ring focus-visible:ring-primary`}
              >
                                ...
                                <div className="bg-black ml-3  mr-3 mx-auto grid grid-cols-1 justify-center gap-4">
                                  ...
                                  <div className="py-1">
                                    <div className="flex flex-row space-between-2">
                                      <Select name="dept"  >
                                        <SelectTrigger className="w-auto focus:border-primary mr-1 text-[#fff] border-[#fff]">
                                      ...
                                      <Select name="type"   >
                                        <SelectTrigger className="w-auto ml-auto focus:border-primary  text-[#fff] border-[#fff]">
                              ...
                              <div className="mr-auto px-2   mt-auto grid grid-cols-1 border border-black rounded-md">
                                ...
                                >
                                  <select
                                    ...
                                    className='bg-black border border-white  text-foreground  focus:border-primary rounded-md p-2 '
                                  >
