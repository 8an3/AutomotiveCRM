          ...
          <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card className='border border-white text-foreground'>
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                      ...
                      <div className="ml-5">
                        <Form method='post' className="space-y-4">
                          <div className="grid w-full max-w-sm items-center gap-1.5">
                            <Label htmlFor="email" className='text-foreground'>Dealer Name</Label>
                            <Input type="text" id="email" name="dealerName" />
                          </div>
                          <div className="grid w-full max-w-sm items-center gap-1.5">
                            <Label htmlFor="email" className='text-foreground'>Dealer Phone</Label>
                            <Input type="text" id="email" name="dealerPhone" />
                          </div>
                          <div className="grid w-full max-w-sm items-center gap-1.5">
                            <Label htmlFor="email" className='text-foreground'>Dealer Address</Label>
                            <Input type="text" id="email" name="dealerAddress" />
                          </div>
                          <div className="grid w-full max-w-sm items-center gap-1.5">
                            <Label htmlFor="email" className='text-foreground'>Dealer City</Label>
                            <Input type="text" id="email" name="dealerCity" />
                          </div>
                          <div className="grid w-full max-w-sm items-center gap-1.5">
                            <Label htmlFor="email" className='text-foreground'>Dealer Province</Label>
                            <Input type="text" id="email" name="dealerProvince" />
                          </div>
                          <div className="grid w-full max-w-sm items-center gap-1.5">
                            <Label htmlFor="email" className='text-foreground'>Dealer Postal Code</Label>
                            <Input type="text" id="email" name="dealerPostal" />
                          </div>
                          <div className="grid w-full max-w-sm items-center gap-1.5">
                            <Label htmlFor="email" className='text-foreground'>Dealer Email</Label>
                            <Input type="text" id="email" name="dealerEmail" />
                          </div>
                          <ButtonLoading
                            size="lg"
                            value='updateFinance'
                            className="w-auto cursor-pointer ml-auto mt-5 hover:text-primary text-foreground border border-white"
                            name="intent"
                            type="submit"
                ...
                <Card className="col-span-3 border border-white text-foreground">
                  <CardHeader>
