          ...
          <AccordionContent>
            ...
            <div className="flex flex-col mx-auto justify-center mt-5">
              ...
              <Popover>
                ...
                <PopoverContent className="w-2/3 bg-slate1 border border-slate12 text-[#fafafa] p-0" align="start">
                  <div>
              ...
              <select
                name="pickUpTime"
                className={`mx-auto w-2/3 mb-2 text-xs mt-3 h-10 cursor-pointer rounded border-1 border-[#60b9fd] bg-slate1 text-[#fafafa]  shadow transition-all duration-150 ease-linear focus:outline-none focus:ring focus-visible:ring-[#60b9fd] `}>
