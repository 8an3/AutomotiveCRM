      ...
      <>
        <Dialog.Root open={financeIdMenu} onClose={handleClose}>
          <Dialog.Trigger asChild>
            {financeIdState && (
              <Button onClick={handleClickOpen} className='text-foreground mt-5'>
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content className="data-[state=open]:animate-contentShow fixed bg-background text-foreground top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
