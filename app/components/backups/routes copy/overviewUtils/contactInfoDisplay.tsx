...
export default function ContactInfoDisplay({ finance, handleChange, formData }) {
            ...
            <div className="flex flex-wrap justify-between  ">
              ...
              <div className="grid grid-cols-1">
                ...
                <select
                  ...
                  className="mx-auto mt-3 w-2/3  cursor-pointer rounded border-0 ml-2 mr-2 bg-slate1 px-3 py-3 text-sm text-slate12 placeholder-blue-300 shadow transition-all duration-150 ease-linear focus:outline-none focus:ring focus-visible:ring-[#60b9fd]">
              ...
              <div className="grid grid-cols-1">
                ...
                <select
                  name='typeOfContact'
                  className='w-2/3  mx-auto  text-xs  mb-2 cursor-pointer rounded border-1 border-[#60b9fd] bg-slate1 text-slate12  shadow transition-all duration-150 ease-linear focus:outline-none focus:ring focus-visible:ring-[#60b9fd]'>
