...
export function Example() {
  ...
  return (
    <>
      <div className="mx-auto justify-center mb-[5px]">
        <div className="flex h-[98vh] w-[98w] mx-auto ">
          <div className="w-1/3 h-[100&] border border-[#ffffff4d] grid grid-cols-1 space-y-2">
            ...
            <div className={`mx-auto  hover:text-[#02a9ff]  ml-2 mt-2 w-[98%] cursor-pointer  h-auto  rounded-md p-3  grid gris-cols-2 `}
              onClick={() => {
                handleNewClick()
              }} >
              <div className="h-auto max-h-[950px] overflow-y-auto border-b border-[#3b3b3b]">
                ...
                <div className="flex">
                  <p className="text-[#fff] ml-3 hover:text-[#02a9ff]">New Template</p>
                </div>
                      ...
                      >
                        ...
                        <Form method="post">
                          ...
                          <div className="bg-slate12 ml-3  mr-3 mx-auto grid grid-cols-1 justify-center gap-4">
                            ...
                            <div className="relative">
                              <Input name="title"
                                className="text-[#fff] border-[#fff] bg-slate12 block w-full pl-[115px]"
                                type="text" />
                              <label className="absolute left-2 top-[6px] text-[#fff]">Template Title:</label>
                            </div>
                            <div className="relative ">
                              <Input
                                ...
                                className="text-[#fff] border-[#fff] bg-slate12 block w-full h-10 pl-[65px]"
                                type="text" />
                              <label className="absolute left-2 top-2 text-[#fff]">Subject:</label>
                            </div>
                            {/* Row 2 */}
                            ...
                            <div className="relative">
                              <Input
                                name="category"
                                type="text"
                                className="text-[#fff] border-[#fff] bg-slate12 block w-full h-10 pl-[80px]"
                              />
                              <label className="absolute left-2 top-2 text-[#fff]">Category:</label>
                            </div>
                            {/* Row 3 */}
