...
export function DataTablePagination<TData>({
  ...
  return (
    <div className="flex items-center justify-between px-2">
      <div className="flex-1 text-sm text-gray-300-foreground">
      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        <div className="flex items-center space-x-2">
          ...
          >
            <SelectTrigger className="h-8 w-[70px] cursor-pointer border border-gray300">
        ...
        <div className="flex items-center space-x-2">
          <Button
            ...
            className="hidden w-15 p-0 lg:flex bg-blackA6  cursor-pointer "
          ...
          <Button
            ...
            className="h-7 w-13 p-0 bg-blackA6  cursor-pointer "
          ...
          <Button
            ...
            className="h-8 w-15 p-0 bg-blackA6  cursor-pointer  "
          ...
          <Button
            ...
            className=" h-8 w-15 p-0 lg:flex bg-blackA6  cursor-pointer "
