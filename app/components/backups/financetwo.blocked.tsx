...
import { overviewLoader, overviewAction, financeIdLoader } from '../actions/overviewActions'
import { useFetcher, useLoaderData, useParams, useRouteLoaderData, Form } from '@remix-run/react'
...
export async function action({ request }: LoaderArgs) {
  ...
  const saved = await prisma.lockFinanceTerminals.update({
    where: {
      id: 1,
    },
    data: {
