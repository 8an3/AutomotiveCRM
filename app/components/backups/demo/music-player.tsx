...
export function MusicPlayerDemo() {
  return (
    <div className="overflow-hidden rounded-md border-2 border-surface-200 bg-gradient-to-b from-brand-300 to-blue-300  dark:from-brand-800 dark:to-blue-800">
                  ...
                  >
                    ...
                    <div className="flex h-[450px] shrink-0 items-center justify-center rounded-md border-2 border-dashed border-surface-200 dark:border-surface-700">
                      <div className="mx-auto flex max-w-[420px] flex-col items-center justify-center text-center">
                        <Podcast className="h-10 w-10 text-black" />
                        <h3 className="mt-4 text-lg font-semibold text-surface-900 dark:text-surface-50">
                          No episodes added
                        </h3>
                        <p className="mb-4 mt-2 text-sm text-surface-500 dark:text-black">
  ...
  return (
    <div className={cn("space-y-3", className)} {...props}>
      ...
      <div className="space-y-1 text-sm">
        ...
        <p className="text-xs text-surface-500 dark:text-black">
          {album.artist}
        </p>
      </div>
    </div>
