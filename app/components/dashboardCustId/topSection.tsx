  ...
  return (
    <>
      ...
      <div className=" grid lg:grid-cols-2 grid-cols-1 mx-auto gap-4 md:mx-2 mr-2">
          ...
          <div className="h-full w-full">
            <div className="flex-1 mx-auto grid  h-[210px]   text-slate2 border border-[#43484E] p-4 rounded-lg shadow uppercase font-bold text-[15px]">
              <div className='justify-between items-center'>
                <h2 className='text-[#fafafa]'>{finance[0].name}</h2>
              </div>
              <div onClick={() => copyText(phone)} className='cursor-pointer flex justify-between hover:text-[#02a9ff]'>
                <p className='mr-2 text-[#fafafa] hover:text-[#02a9ff]'>{phone}</p>
              ...
              <div onClick={() => copyText(email)} className='cursor-pointer flex justify-between hover:text-[#02a9ff]'>
                <p className='mr-2 text-[#fafafa] hover:text-[#02a9ff]'>{email}  </p>
              ...
              <p className='mr-2 text-[#fafafa]'>{address}  </p>
              <p className='mr-2 text-[#fafafa]'>{city}{appostraphe} {clientFile.province}   </p>
              <p className='mr-2 text-[#fafafa]'>{clientFile.postal} </p>
        ...
        <div className="">
          <div className="flex-1 bg-[#09090b] text-[#fafafa] border border-[#43484E] p-4 rounded shadow uppercase font-bold text-[15px] h-[210px]">
        ...
        <div className="">
          <div className="bg-[#09090b] text-[#fafafa] border border-[#43484E] p-4 rounded shadow uppercase font-bold text-[15px]">
            {/* deaal status */}
            <SalesButtonCard
              user={user}
              finance={finance}
        ...
        {/* Second Row */}
        <div className="">
          <div className=" flex-1 bg-[#09090b] text-[#fafafa] border border-[#43484E] p-4 rounded shadow uppercase font-bold text-[15px]">
        ...
        <div className="">
          <div className="bg-[#09090b] text-[#fafafa] border border-[#43484E] p-4 rounded shadow uppercase font-bold text-[15px] text-[15px]">
            {/* parts status */}
            <PartsCard
              finance={finance}
              user={user}
