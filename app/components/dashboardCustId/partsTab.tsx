...
export function PartsTab({ timerRef, open, setOpen, user, }) {
  ...
  return (
    <div className="grow p-5 rounded-tl-md bg-myColor-900 text-foreground rounded-b-md outline-none  focus:shadow-black"
    >
...
export function SearchTable() {
  ...
  return (
    <div className="mx-auto w-[95%] ">
            ...
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                ...
                >
                  ...
                  <TableCell>
                    <Button name='add' className='text-foreground' variant='outline' onClick={() => {
      ...
      <div>
        <Card className="bg-background w-[50%]">
          <CardHeader>
            Order Details
          </CardHeader>
          <CardContent>
