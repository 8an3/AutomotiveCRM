...
import UnitInv from "../../../routes/__authorized/dealer/sales/inventory";
...
export default function NewUnit() {
  ...
  return <UnitInv />;  // Render `UnitInv` as a component
}
    ...
    <div className="w-[95%] mt-[15px] mx-auto">
      ...
      <div className="container mx-auto py-3">
        ...
        <div className="rounded-md border border-border    h-auto max-h-[600px] overflow-y-auto  ">
          <Table className=' overflow-x-auto  max-w-[100%] border border-border text-foreground bg-background'>
            ...
            <TableBody className='overflow-x-auto  max-w-[100%]  border border-border text-foreground bg-background '>
