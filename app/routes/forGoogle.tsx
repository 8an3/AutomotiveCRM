  ...
  return (
    <>
      ...
      <p className='mt-[100px] w-1/2 mx-auto text-center'>
        For authentication, google_order_66@gmail.com google_order_66, this account will have a "SUBSCRIPTION" already activated. Once the verification process has concluded I will reverse this so a subscription is needed for individuals. If at any time you need to review this again let me know and I will make it so. If needed, I can also invite you, or make the repo public for a code review.
      </p>
      <br />
