  ...
  return (
    <>
      ...
      <p className='mt-[100px] w-1/2 mx-auto text-center'>
        For authentication, ordersixsix142@gmail.com google_order_66, this account will have a "SUBSCRIPTION" already activated. Only issue with this is that its not a real gmail account and because of that no emails will show up.... ill make it for you guys right now. Once the verification process has concluded I will reverse this so a subscription is needed for individuals. If at any time you need to review this again let me know and I will make it so. If needed, I can also invite you, or make the repo public for a code review.
      </p>
      <br />
