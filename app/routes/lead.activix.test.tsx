...
export async function loader({ request, params }: LoaderFunction) {
  ...
  const activixData = await CallActi(); // Assuming this function returns ActivixData
  ...
  for (const data of dataObjects) {
    ...
    const existsInDatabase = await checkFieldInDatabase(data.id); // Check if the record exists in the database
