                ...
                return <>
                    <div className='mx-auto my-auto'>
                        <Form method='post'>
                            ...
                            <Button variant='outline' name='intent' value='deleteWishList'
                                className="active:bg-black mx-auto my-auto h-7  cursor-pointer rounded bg-slate12 px-3 py-2  text-center text-xs  font-bold uppercase text-slate1 shadow outline-none  transition-all duration-150 ease-linear hover:border-[#02a9ff]  hover:text-[#02a9ff] hover:shadow-md focus:outline-none"
                            >
                                Delete
                            </Button>
                        </Form>
                    ...
                    <DialogContent className="sm:max-w-[425px] bg-[#fff]">
                        ...
                        <Form method='post' className="grid gap-4 py-4">
                            ...
                            <Button onClick={() => toast.success(`Added to wish list!`)}
                                type='submit' name='intent' value='addWishList' variant='outline'
                                className="active:bg-black w-[75px] mt-10 mx-2 my-auto h-7  cursor-pointer rounded bg-slate12 px-3 py-2  text-center text-xs  font-bold uppercase text-slate1 shadow outline-none  transition-all duration-150 ease-linear hover:border-[#02a9ff]  hover:text-[#02a9ff] hover:shadow-md focus:outline-none"
                            >
                                Save
                            </Button>
                        </Form>
