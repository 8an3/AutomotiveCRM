...
export async function loader({ request, params }: LoaderFunction) {
  ...
  const clientfileRecords = await prisma.clientfile.findUnique({
  ...
  return json({
    ...
    request,
    wishlistMatches,
    email, products, emailTemplatesDropdown,
    // conversationsData
...
export default function FinanceDialog() {
  const { finance, user, deFees, products, emailTemplatesDropdown, clientFile, sliderWidth, aptFinance3, Coms, getTemplates, merged, clientUnit, financeNotes, userList, modelData, manOptions, bmwMoto, bmwMoto2, notifications } = useLoaderData();
  const data = finance
  ...
  return (
    ...
    <div className=" mt-[75px] mx-auto my-auto w-[95vw] max-w-[95vw] grid grid-cols-1 lg:grid-cols-3 max-h-[800px] h-[800px]">
      ...
      <Tabs defaultValue="Sales">
        <Card className="w-[95%]  bg-background text-foreground rounded-lg   max-h-[750px] h-[750px] " x-chunk="dashboard-05-chunk-0"  >
          ...
          <CardFooter className="mt-[7px] grid grid-cols-2 justify-between items-center border-t border-border bg-muted/50 px-6 py-3">
            <Button size="sm" variant="outline" className="h-8 gap-1 mr-auto bg-background text-foreground" onClick={() => {
              navigate("/dealer/leads/finance");
