...
import calculator from '~/images/favicons/calculator.svg'


export const links: LinksFunction = () => [
  { rel: "icon", type: "image/svg", href: calculator },
];
...
export const meta: MetaFunction = () => {
  return [
    { title: "Payment Calculator || SALES || Dealer Sales Assistant" },
    {
      property: "og:title",
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              ...
                              >
                                ...
                                <span className="sr-only">Other tax %</span>
                              </Button>
                            </TooltipTrigger>
                          ...
                          <Select
                            ...
                            <SelectContent className='bg-background text-foreground border border-border'>
                              <SelectGroup>
                                ...
                                <SelectItem value='0' className='cursor-pointer hover:bg-accent hover:text-accent-foreground'>0%</SelectItem>
                                <SelectItem value='5' className='cursor-pointer hover:bg-accent hover:text-accent-foreground'>5%</SelectItem>
                                <SelectItem value='11' className='cursor-pointer hover:bg-accent hover:text-accent-foreground'>11%</SelectItem>
                                <SelectItem value='12' className='cursor-pointer hover:bg-accent hover:text-accent-foreground'>12%</SelectItem>
                                <SelectItem value='13' className='cursor-pointer hover:bg-accent hover:text-accent-foreground'>13%</SelectItem>
                                <SelectItem value='14.975' className='cursor-pointer hover:bg-accent hover:text-accent-foreground'>14.975%</SelectItem>
                                <SelectItem value='15' className='cursor-pointer hover:bg-accent hover:text-accent-foreground'>15%</SelectItem>
                              </SelectGroup>
                            </SelectContent>
                          </Select>
                        </span>
