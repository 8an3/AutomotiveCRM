...
import { Form, Outlet, useFetcher, useLoaderData, useParams, useSubmit, Link, useNavigate, useLocation, } from "@remix-run/react";
  ...
  return (
    ...
    >
      {mergedFinanceList && mergedFinanceList.map((item) => (
        <Link
          key={item.to}
          to={`/dealer/sales/customer/${item.clientfileId}/${item.financeId}`}
