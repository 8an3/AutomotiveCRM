...
import { getExpandedRowModel, flexRender, getCoreRowModel, getFilteredRowModel, getPaginationRowModel, getSortedRowModel, useReactTable, Column, getFacetedRowModel, getFacetedUniqueValues, getFacetedMinMaxValues, sortingFns } from "@tanstack/react-table";
...
export async function loader({ request, params }: LoaderFunction) {
    ...
    const finance = await prisma.finance.findMany({
        where: { financeManager: user?.email },
        select: {
            financeManager: true,
            userEmail: true,
            userName: true,
    ...
    const webLeadData = await prisma.financeApplication.findMany({ where: { finMgrEmail: null } }) //finance.FinanceApplication
