    ...
    <div className='border border-white rounded-md w-[500px] justify-center mx-auto' style={{ textAlign: 'center' }}>
      ...
      <div className='grid grid-cols-2 justify-between mr-8 ml-8'>
        <Form method="post" encType="multipart/form-data" className='items-center'>
          ...
          <Button disabled type="submit" className="  text-foreground border-white  border py-2 px-3  mt-2">
            UPLOAD CSV
          </Button>
        </Form>
        <div className='mt-5 mb-5' style={{ textAlign: 'center' }}>
          ...
          <p className='text-foreground'>Part 1 - Finance </p>
          <Button onClick={() => Click1()} className="text-foreground border-white border py-2 px-3 rounded-md mb-5  mt-2">
            DOWNLOAD CSV
          </Button>
        </div>
      </div>
