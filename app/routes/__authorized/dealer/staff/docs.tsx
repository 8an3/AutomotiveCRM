...
import file from '~/images/favicons/file.svg'

export const meta: MetaFunction = () => {

  return [
    { title: 'Docs || STAFF LOUNGE || Dealer Sales Assistant' },
    {
      property: "og:title",
...
export const links: LinksFunction = () => [
  ...
  { rel: "icon", type: "image/svg", href: file },
    ...
    <>
      <div className=" space-y-6 p-10 pb-16 h-screen w-screen">
        <div className="space-y-0.5">
          <h2 className="text-2xl font-bold tracking-tight text-foreground">Docs</h2>
