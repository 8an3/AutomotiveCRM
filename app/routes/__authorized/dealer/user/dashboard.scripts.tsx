...
import { Badge, Button, Input, Label, Select, SelectContent, SelectGroup, SelectLabel, SelectItem, SelectTrigger, SelectValue, Tabs, TabsContent, TabsList, TabsTrigger, TextArea, Separator, buttonVariants } from "~/components/ui";
...
export default function Shight() {
  ...
  let script = [
    ...
    {
      subject:
        "Concerns? let me taking them to the boss lets get them resolved",
      body: "I've noticed that you may have some concerns about the current deal we're discussing. What would it take to make it more appealing to you? While I can't guarantee that we can fulfill every request, I'm more than willing to take your conditions and present them to my manager. I've been collaborating with him for several years now, so I have a good understanding of how and when to negotiate to get favorable terms into deals, always within reasonable boundaries, of course. Your satisfaction is our priority, and I'm here to work with you to find a solution that suits your needs.",
      category: "Overcome",
...

    {
      ...
      category: "Closes",
      subCatLisst:
        "Check in and see if you had any further questions or concerns",
    },
    {
    ...
    {
      subject:
        "I understand that purchasing a motorcycle can be a big decision",
      body: "I understand that purchasing a motorcycle can be a big decision, but I want to remind you that the Street Glide is currently available at the price we discussed. I would be happy to go over all te features it has again with you. Would this afternoon work for you or would tomorrow fit your schedule better?",
      category: "Closes",
      subCatLisst:
        "I understand that purchasing a motorcycle can be a big decision",
    ...
    {
      subject:
        "It's clear that you may have some reservations about the current deal.",
      body: "I take pride in being the best salesperson I can be and assisting as many people in my community as possible. It's clear that you may have some reservations about the current deal. If you don't mind sharing, I'd love to know what we can adjust or improve to make it a more attractive offer for you. Your feedback is invaluable, and I'm here to work together on a solution that meets your needs and expectations.",
      category: "Closes",
      subCatLisst:
        "It's clear that you may have some reservations about the current deal.",
    ...
    {
      subject:
        "We'll refund the deposit when you come to pick up your new bike",
      body: "To move forward with your purchase, we would need a $500 deposit and a picture of your driver's license. This will allow us to initiate the process for our finance manager to go over the application with you.  We understand that making a financial commitment is an important step, and we want you to feel comfortable. If you're hesitant about putting money down for financing, please know that it's perfectly okay. In fact, we have a flexible approach, and we'll refund the deposit when you come to pick up your new bike.  We genuinely want to make this process as smooth and convenient for you as possible. Could you please let us know which payment option you're most comfortable with?",
      category: "Closes",
      subCatLisst:
        "We'll refund the deposit when you come to pick up your new bike",
    ...
    },
    {
      ...
      body: (
        <div className="bg-background1 text-slate3 grid w-full  items-center ">
          <p>
            Do not order/promise parts to a customer who has not signed a bill
            of sale.
          </p>
          <p className="mt-3">
            We have seen entire dealers fall prey to this. A customer comes in,
            orders a part on a unit at the time of purchase, and then the week
            of pick up or even the day before customer tries to cancel or change
            the part. If the bill of sale is not signed you legally cannot force
            them to take it even if its installed.
          </p>
          <p className="mt-3">
            Your service dept, if its run well. Would have had this completed
            the week before. It is already installed. The customer signed for
            it, the customer is taking it. Your dealer put up the funds to order
            this part. The service dept put in the labour hours to install the
            part. It's only fair that the customer took the unit with it
            installed if they did not give you proper time to adjust the order.
          </p>
          <p className="mt-3">
            At the time of purchase when signing: "I have listed the parts and
            accessories you wanted on the bill of sale so that we can order them
            ahead of time and have them installed before you pick up your unit.
            This way you can enjoy your unit right away. This also ensures that
            incase the part is on back order, we can try to find a replacement
            part before you pick up. If you need to cancel the part you need to
            give me at least 2-3 weeks notice because my service dept will prob
            work on your unit the week or two before. This doesn't mean your
            unit will be ready at that time, its just that incase the service
            dept is on schdule we like to prep units early. That way if anything
            is wrong at the time of the PDI, we can notify you that we need to
            change the pick up date. Customers do not appreciate being called
            the day of or the day before informing them that it's not ready
            because the manufacturer forgot a bolt, or the shipping company
            dented a panel. I want your pick up to be as smooth as possible, so
            sign here."
          </p>
          <p className="mt-3">
            I dont care if my finance dept cries about not being able to sell
            their products, after its signed. Too bad. This is for the dealer as
            a whole, not just the finance managers pocket. They should be there
            to help the customer when the customer AND dealer needs it. Bills of
            sales need to be signed asap. We will touch more on this later with
            ordering units as well.
          </p>
          <p className="mt-3">
            Are you here to make money? Yes. BUT your also there to protect the
            dealer and its finances. Have we sold we sold units to nigerian
            princes? Yes, we will take cash all day long, those 15 units were
            paid for in cash. Have we sold parts lists that are so long the
            sales manager freaks out? Yes, but before getting a signed bill of
            sale we asked the sales manager how much down. The list value was
            more than $ figure of the unit itself. The list was so big, the
            manager didn't have faith, gave a huge deposit thinking it wouldnt
            go through. Still sold it, manager still freaked out. Did the
            customer have the chance to back out on single part? No. Bill of
            sale was signed along with a description on the bill it self.
          </p>
          <p className="mt-3">
            You need to protect the dealer in a lot of ways. On every part you
            order is on credit, most likely. You need your customers commitment
            to pay for it. If there is an objection, just explain. "We as a
            dealer are ordering this part for you, some parts are very sellable
            yes, others no. Lets be honest here, I want to give you exactly what
            you want but we also need your commitment. I cant take customer
            promises on every unit I sell, I would go broke just from inventory
            credits."
          </p>
          <p className="mt-3">
            Whenever you talk real to the customer, whether about parts and
            accessories, or any other issue or subject. The customer will not
            only appreciate, but understand you. If after all the explantion,
            the customer "changes their mind", this means that the customer
            didn't really want it to begin with. Be happy about this, because
            you just saved yourself from getting yelled at the time of pick up
            by management.
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      body: (
        <div className="mt-3 grid w-full items-center">
          <p>
            Do not order/promise a unit to a customer who has not signed a bill
            of sale.
          </p>
          <p className="mt-3">
            Were not going to repeat everything from the last one. But continue
            on, almost.
          </p>
          <p className="mt-3">
            A deposit means nothing. I dont care if its your first day, or your
            tenth year. A deposit still allows the customer to back out. Why are
            you commiting time, resources and probably headaches of not only
            your self but to others in your dealer.
          </p>
          <p className="mt-3">Got a yes? Sign, right away. Why wait.</p>
          <p className="mt-3">
            A lot of sales people are so eager, or hungry to get the sale. They
            just get a deposit. It means nothing because there is no commitment.
            Maybe they are afraid of contracts. Don't be, if your dealer allows
            sales people to sign contracts. Practice, alot. This is a great
            skill to have for the sales process. I will, at nauseam, go over
            every line with every customer for every deal. Even if they bought a
            unit off of me yesterday. That way, there is no confusion after the
            sale. Nothing for the customer to come back saying they are confused
            about this or that. Whenever you hear customers say this, that
            person didn't do their job. Finance manager's are notorius for this.
            They don't have to be, they're afraid if they explain it the way
            they should, they won't sell their products. Their wrong, you can
            explain it in a way the customer isn't confused after the sale, and
            still sell their product. I dont get calls, a week, month or year
            later asking about some random fee that was never explained.
          </p>
          <p className="mt-3">
            If your in a dealer where only the finance manager signs the
            customer: This is where finance managers might get mad. BUT they
            need to be available, on the customers terms, not theirs. Customers
            walks in, says yes, but your finance manager says hes going on lunch
            and would rather call them after or schedule a meeting a week from
            now. Fuck no. Your the finance manager, getting paid more than the
            sales guys. Shut the fuck up, do your job and sign the customer. THE
            SALES PERSON GOT THE YES, WHICH MAKES THE FINANCE MANGERS JOB EASIER
            TO SELL. The sales person has the hardest job in the dealer. The
            amount of rejection and stuff we have to go through. I wish I could
            have someone presell my customers and only deal with yes'. At the
            same time I don't get the same rush from that. The finance managers
            need to stop crying. The dealer is not bowing to the finance dept
            are they? No. The dealer is not bowing to the sales person are they?
            No. Do your job when it needs to be done. I do not care how much
            your getting paid, to be honest, I expect more from the ones I'm
            paying more. So if that bill needs to be signed and your
            dealer/finance mangers are the ones doing the signing. They need to
            be there when the customers says yes. Not a week from now.
          </p>
          <p className="mt-3">
            I have been a GM, sales manager, and a sales person. I have done it
            all. As a sales person I have even managed sales managers.
          </p>
          <p className="mt-3">
            I understand the sales process of the box, I've done it. I
            understand that every finance manager wants a piece of the action. I
            will help them make as much money for them as they will. With saying
            that, do not put my customer on hold for any reason. Because its not
            just my customer their putting on hold, its the dealers customer.
          </p>
          <p className="mt-3">
            Show your finance, or sales manager this if your not comfortable
            having this conversation. If this is an issue in your dealer, this
    ...
    },
    {
      ...
      body: (
        <div className="mt-3 grid w-full items-center">
          <p>
            In the world of sales, no one can close every deal in a dealership.
            While I've seen it happen in other industries, the automotive sector
            presents a different reality.
          </p>
          <p className="mt-3">
            It's not just about you; it's about the general perception customers
            have about salespeople and dealerships.
          </p>
          <p className="mt-3">
            Instead of accepting defeat like every other dealer, why not respond
            differently? In doing so, you might end up gaining more customers
            than you initially expected, including those who bought elsewhere.
          </p>
          <p className="mt-3">
            "Congratulations! I hope the unit meets your expectations. If you
            have any questions, whether about insurance or the best roads to
            ride on, feel free to ask. I'm more than happy to assist you."
          </p>
          <p className="mt-3">
            When someone you've just informed about not moving forward with a
            sale approaches you with such inquiries, they'll remember it.
            Particularly, if they're the type to be open and direct with their
            salespeople. Often, they face hostility because the salesperson
            feels their time was wasted.
          </p>
          <p className="mt-3">
            Although we didn't close the deal today, consider this: What if the
            unit they purchased doesn't meet their expectations, or their
            spouse's? Those are easy sales if you've made a positive impression
            on the husband. Trust us on that one. What if their circumstances
            change in a month and they need something different? What if they
            were eyeing a specific unit, bought elsewhere due to price, but your
            professional handling of the situation led them to buy their entire
            corporate fleet from you instead? What if they have a friend looking
            to buy a unit and they refer them to you because of how you handled
            the situation?
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      body: (
        <div className="mt-3 grid w-full items-center">
          <p>
            Nothing that we provide here takes skill. It takes confidence.
            Confidence in your self, your product, your dealer and your
            industry.
          </p>
          <p className="mt-3">
            If you don't have confidence in yourself, work on it. If you don't
            have confidence in your dealer or management, either fill in for the
            role that they provide or move on.
          </p>
          <p className="mt-3">
            But an easy way to get a customer talking after a period of no
            response. Or if they seemed ready to buy yesterday and just went
            cold. Ask the question. It will seem too forward most, and I've
            discussed this with many sales coaches who agree with me, almost all
            sales people don't ask the right questions at the right time.
          </p>
          <p className="mt-3">
            "Were there any other questions or concerns that was keeping you
            back from moving forward? I want to make sure you have all the
            information you need before buying so you make an informed buying
            decision, I'm hear to help make the process easy for you."
          </p>
          <p className="mt-3">
            The usaully reaction is, "Do you really say that?" Yes, because I
            need to know why they arent moving forward when they contacted me.
            That way I can address the concerns they have, when they are having
            them. Most of the time, they are trivial and so easy to overcome
            that its just low lieing fruit. Should I sit at my desk and hope
            they call back again, no. "The Secret", belongs more in other
            sections of the book store than where it currently resides. Wishful
            thinking is not a sales tactic.
          </p>
          <p className="mt-3">
            The force is not real, you can't move things with your mind. You can
    ...
    },
    {
      ...
      body: (
        <div className="mt-3 grid w-full items-center">
          <p>
            Glengarry Glen Ross, the amount of times I see this in real life.
            Blows my mind. Never really experinced it in my own dealer till
            recently. Everyone just wanted to be on coffee breaks. It was
            insane. 2-3 hour long coffee breaks.
          </p>
          <p className="mt-3">
            I was doing web leads, only. In the second month I was acheiving
            higher sales then the rest of the floor, with lower quality leads on
            a product lineup I've even looked at before. I was doing the exact
            opposite of what they were doing.
          </p>
          <p className="mt-3">
            Are coffee breaks and shooting the shit fun? Yes, dont get me wrong,
            but your there to work. Will they dislike you for it. 100% when they
            see you making sales when their not. I dont mean to disrespect my
            colleagues by ignoring them. I really dont, if you ever worked with
            me and you felt that way, i know most have, I'm sorry. I even take
            calls when Im on dates with my wife. I love it when the in-laws are
            in town. We go out to dinner, they talk amongst themselves and I
            hammer out emails/texts. She gets annoyed and taps my arm and asks
            what im doing. Just sold 4 units why whats up? How is she going to
            complain about that, when I'm not even included in the conversation.
          </p>
          <p className="mt-3">
            The sales people who are really making big numbers, are not doing it
            because of skill. It's hard work.
          </p>
          <p className="mt-3">
            When I was a sales manager at a door to door company, I noticed this
            with some phenomonal people. This is where hard work really shines.
            There was one employee that worked harder than anyone else. He was
            horrible at sales, not entirely his fault because he was on the
            spectrum. But he realised that, and if he wanted to compete with
            some of the other sales people he had to knock on more doors than
            anyone else. Did he have really bad days? He did, I felt bad every
            time these happened. Did he beat some of the best sales people in
            our location some days? Yes, just from pure brutal grueling hard
            work of banging on doors all day. When he won those days, he would
            chirp people so bad, I cracked ribs from laughing so hard hearing
            what was coming out his mouth.
          </p>
          <p className="mt-3">
            Take me for exmaple, at that same door to door company. I started
            with no sales experience. I was horrible. So horrible when I had
            good days no body would beleive it, sometimes we worked in pairs and
            they would assume that the person I was with was the one doing the
            selling. That hurt but I moved on. Worked hard, put my head down and
            kept at it. There were bad days, but the days kept getting better.
            The last day of sales, in the last year I was there, it was the end
            of the season. Literally the last day before we closed for the year.
            We were selling a product/service that we were not going to provide
            anymore. The top sales person in the company, was like fuck it im
            taking the rest of the day off. Because I was a manager, who wanted
            to work the rest of the season as a sales person I was given first
            shot at her location. We were so far behind in daily sales, she
            didnt think anything of it. Thankfully I've been a manger for the
            last 5 years and can coach people when they need it. Along with the
            sales skills I've accumulated we fucking crushed it. It was myself
            and one other sales person working together
          </p>
          <p className="mt-3">
            This kid was amazing at sales, but he was a mess. If he didnt get a
            yes every 15 minutes, he had a mental breakdown. If I wasn't
            closing, I was coaching. I've never told anyone this actual story.
            We went till 11pm if I remember correctly. We crushed it so hard,
            didn't eat, didnt break nothing. As good as a sales person as he
            was, I was keeping up with him. He was the best in their location.
            If i hadnt been a sales manager and was trained to coach, we would
            have never beaten that record that day. The kid was falling apart
            too much. As soon as I see him slipping I would coach him for a
            minute and then get back to sales. He would then start closing
            again. It was the last day to make money, I wasnt even thinking
            about anything else. Handed in our money when we were dragged away
            from management. Back at the office, I didn't realize anything that
            was going on because I was eating on the other side of the office at
            midnight. She was so mad I heard her screaming.
          </p>
          <p className="mt-3">
            I had taken her sales record, on the last day in the last hour.
            Because I started at 8 that day, I was the one that took her record
            not my partnet and I. The first partner went home when I went to the
            other location. My second partner started at 3 in the afternoon.
            From last to first. She started making so many excuses, she was so
            furious because of how competitive she was. Sorry, its not my fault
            you suck and that you just wanted to be lazy.
          </p>
        </div>
      ),
      category: "Tips and Tricks",
    ...
    },
    {
      ...
      body: (
        <div className="mt-3 grid w-full items-center">
          <p>
            A lot of sales places you won't benefit from this as much as others.
            Start practicing this now, and you will see the benefits later.
          </p>
          <p className="mt-3">
            I was taught this in door to door, and forced to do it in
            automotive. Seriously, no discounts 98% of the time. It's not easy
            but I'll explain why you should anyways.
          </p>
          <p className="mt-3">
            That customer took time out of their day to bug you. Your busy
            dealing with customers, paperwork and whatever else. Are they being
            paid to come to the store? No. Are you being paid to sell? Yes, so
            whos time is more valuable in this situation. You came to me in some
            form or fashion, I didn't come to your workplace to try to sell you
            what I have. My time is important and I need to dedicate it to
            people who will buy. So I assume I'm closing you. Every single
            person. Because if your not here to buy, how dare you waste my time.
            The amount of stuff I have to do in a day and your trying to take
            some of that time and waste it? I will not let you.
          </p>
          <p className="mt-3">
            I was headhunted by a construction company, right in the middle of
            the pandemic. I'm 6'2 or 3, started growing my beard before the
            pandemic, but because of every shop being closed, it just grew huge.
            Tattoos, resting bitch face. As you can tell I'm not the most
            approachable person. Compared to the other staff in this
            construction company? The top sales people were a group of 4 women
            who dressed like they were hitting the bars every day. They looked
            at me like I wasn't going to make any sales or last long there. I
            gave that company the thing they needed most, when they needed it.
            Pandemic everyone was buying. This constrctino company had
            advertising dialed, to such a degree that your leads were so hot. I
            have never experienced this before. Especially in automotive.
            Remember my attitude though? Off the hop, started to kill it. I was
            told I was the fastest to 100k in commision than anyone before. Day
            after day, being new I got less calls to get accumulated to the new
            enviroment, I was still crushing it. Quite a few days I was top in
            commision. Not in sales, because I didnt have enough calls. But top
            in commision because this company really paid when you didn't
            discount. Those women got mad. I can see there point, I was doing
            half or a third of the amount of calls.
          </p>
          <p className="mt-3">
            How is this big intimidating guy doing so well? Why hasnt he
            discounted anything? They complained to the owner so much so that he
            called me to, "adjust" my sales tactics. My closing rate that week,
            82%, I dont care who you are but that kind of sales figures is
            insane. Who the fuck Closes at over 80%. No one. Was I the only one
            doing it at that company though? There was one other person that
            week with more follwing extremely close, thats how good and refined
            their advertising and sales funnel was. I got a call, demanding I
            start to discount because I was leaving 18% of sales on the table. I
            thought this was a joke, I laughed so hard. Got me in more trouble
            because he was serious. I straight up told him, Why do you want me
            to devalue your service for you? Your service is worth what it is
            priced at. If im closing at 82% the pricing is fine where it is, if
            anything you can charge more. This was like a month and a half in,
            so I was proving you did not need to discount. Everyone took notice,
            and what started to happen? Over time, everyones discounts started
            to get smaller. By the time I was done there, everyone had decreased
            their discounts.
          </p>
          <p className="mt-3">
            Why did it take me to come in and prove it can be done, for it to
            get done? Why am I on the phone with the owner of the company
            explaining to him why he shouldnt discount. He didnt really like me
            after that conversation. Unfortauntly I had proved him wrong in the
            end so much so that he started to demand his staff not to discount.
            If they did he would cancel the deal. Some people can't take being
            proven wrong. I was only there for 8 months.
          </p>
          <p className="mt-3">
            Why are you discounting? The only reason people discount is because
            they don't beleive in the service. Don't beleive it should be priced
            where it is. Don't beleive in the product. Don't beleive in the
            dealer. Don't beleive in themselves. If you had that beleif, you
            will not discount.
          </p>
          <p className="mt-3">I'll let you in on a secret.</p>
          <p className="mt-3">
            The units are priced at what the manufacturer beleives what they
            should be sold at.
          </p>
          <p className="mt-3">Don't beleive me? I'll prove it to you.</p>
          <p className="mt-3">
            Take the adult toy industry, I'm not talking about sex toys.
            Porches, BMW, Mercedes.... Look at the pricing. Actually take notice
            in whatever country your in.
          </p>
          <p className="mt-3">
            Then pull up other countries, take BMW for exmaple. Most
            recoginisable brand in the world. Noticed how their priced
            differently in each country?
          </p>
          <p className="mt-3">
            I wonder how much money BMW devotes to just invest in learning on
            what to sell their products at. I can garauntee you, if you knew the
            type of figures they spend on this type of research you would be
            floored. Mind blown. How dare you beleive that their product is
            worth less than the msrp. BMW wants to sell more units than anyone
            else.
          </p>
          <p className="mt-3">
            I have been in enough of their training to know this. I know their
            mind set. They didn't become the most recognizalbe brand for no
            reason. There product stack is smart, priced at what it needs to be
            priced in the markets they are in. BMW has incredile funding,
            mountainsly high. Way more than you can imagine. Cars aren't even
            the product that makes them the most money. Imagine what that type
            of funding can provide for each facet of their company.
          </p>
          <p className="mt-3">
            If you think for a second, that they dont research pricing
            sensitivety in each market they are in, you are wrong.
          </p>
          <p className="mt-3">So why the fuck are you discounting?</p>
          <p className="mt-3">
            Are you worth $61 billion? BMW is, and they are more right about
            pricing than you because their doing it in every market they are in.
            Prices are strategically set to help dealers sell more. Not hoping
            you discount in order to sell more. With saying that, very few there
            are, there are brands that torpedo their dealer network. I only know
            of 1. They also treat their customers the same, the exact opposite
            of how bmw treats their customers and dealer network. This company
            is not even worth half a billion. I'm only telling you this last
            part because that type of company, is extremely rare. All the brands
            want you to sell more to gain more penetration in whatever market
            they are in. BMW is not the only company spending resources on this
            type of research. Instead of going against the millions / billions
            of dollars spent and not beleiving in the price, beleive in it.
            There are hundreds of germans in a room, with a lot of money, that
            are smarter than you. They know what they are doing. Take that team
            and use it, instead of discarding it.
          </p>
          <p className="mt-3">
            If your worried about that torpedoing brand, don't because you will
            recognize it immediatly. 99% of people reading this will not be
            selling their products. So start beleiving in what you sell.
          </p>
        </div>
      ),
      category: "Tips and Tricks",
    ...
    },
    {
      ...
      body: (
        <div className="mt-3 grid w-full items-center">
          <p className="mt-3">
            I'v found that sticking to a 7-day delivery rule for all our sales
            can really change the game in tire sales. You know, opting for
            next-day deliveries or anything less than 7 days can cause more
            headaches than you'd think.
          </p>
          <p className="mt-3">
            Imagine this: when we deliver within a day or two, it doesn't give
            us any wiggle room to tackle issues that might pop up. And here's
            the thing, stressing the importance of that bill of sale signature
            can be a game-changer. Tell the customer that without it, their
            vehicle can't even hit the service department's queue.
          </p>
          <p className="mt-3">
            Moreover, it's not just about the signature—it's about efficiency.
            Ordering parts, scheduling services, and dealing with licensing and
            registration all become way smoother with a 7-day window. Plus, we
            can handle unforeseen circumstances much better.
          </p>
          <p className="mt-3">
            Ever noticed how having that extra time results in fewer complaints?
            And it's not just about us; it's a win-win. We get happier customers
            and more deals closed efficiently. It also gives us the flexibility
            to adjust things as needed within that 7-day timeframe.
          </p>
          <p className="mt-3">
            Bottom line, having this approach in place can make our busiest
            sales year also the easiest and most successful. It's all about
            managing expectations and operations in a way that works for
            everyone.
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      body: (
        <div className="mt-3 grid w-full items-center">
          <p className="mt-3">
            dealing with contracts can seem daunting, but let me break it down.
            Getting that bill of sale signed right after the customer says "yes"
            is key. It outlines exactly what they're expecting and what we
            promise to deliver. Plus, it secures their commitment and prevents
            tying up our funds unnecessarily.
          </p>
          <p className="mt-3">
            Now, if you're not contract-savvy, that's okay. Practice makes
            perfect. I go through every line of every contract for every deal.
            Whether it's a seasoned customer buying multiple bikes or a new
            customer, I'll make sure they understand every detail. Yes, it's
            meticulous, but it ensures no confusion.
          </p>
          <p className="mt-3">
            Explaining contracts in a simple, understandable way is vital. I've
            seen finance teams struggle with this. We shouldn't fear losing a
            sale over clarity. Contracts can make everything smooth, especially
            for units going out in a few weeks. It's about setting expectations
            and making sure we have everything ordered and scheduled for service
            in a timely manner.
          </p>
          <p className="mt-3">
            We let the customer know that changes need to be communicated within
            a set timeframe. It's all about efficient coordination. For
            instance, licensing won't be ready until a few days before pickup.
            We've got a lot on our plate, from registrations to warranties, but
            planning ahead helps us deliver seamlessly.
          </p>
        </div>
      ),
      category: "Tips and Tricks",
      ...
      body: (
        <div className="mt-3 grid w-full items-center">
          <p>
            ...
            getting over this one. Related to this is discounting, so many sales
            people just discount right away. FUCK THAT, why are you devaluing
            the product you are selling. The MSRP or product price is set by the
            manufacturer for reason, because that's what it is worth.
          </p>
          <p className="mt-3">
            When I got head hunted for a construction company, covid just
            started. No hair cut, and this was the first time I ever grew my
            beard, it was so long it was almost down to my stomach. With my
            tattoo's I look questionable. So much so I got targeted by cops at
            that time because, I looked like I should be in a biker gang
            snorting meth. So in the sales world, I couldn't be more
            unapproachable, haha. The sales manager training me was worried
            about how bad I would do, to give you context. The whole sales team
            was 25-30 year old blonde bartenders, showing up to work every day
            like they were going clubbing.
          </p>
          <p className="mt-3">
            2 weeks in, I did not discount a single deal. Because I was new, I
            was only getting a quater or a fifth of the calls the girls were
            getting so I can get accustomed to the new products.
          </p>
          <p className="mt-3">
            My commission? The same or more as theirs, and lets just say they
            werent happy about it. My manager told me what they were saying too,
            "How is that 6'3 mountain man not discounting, it makes no sense! Is
            he just threating them or something?" No, it's called believing in
            the value of the product your selling.
          </p>
          <p className="mt-3">
            3rd week in, first sales meeting at the office since covid started.
            Keep in mind, I've never talked to the ceo before this time. He is
            in another meeting in the office with a different dept, with 7
            employees. As soon as he sees me, he stops mid sentence and starts
            talking super loud, "damn me! You fucking killed it this week, you
            made over 10 grand thats fucking insane", and he keeps going. Mean
            while I'm looking at the other employees in the meeting with him,
            and they were not impressed with this behaviour. It was also just
            super fucking weird to do. Not a single person in that meeting was
            on the sales team, their salaries were a lot less. I felt bad for
            the way he was acting.
          </p>
          <p className="mt-3">
            4th week in to this new job I got a call from the CEO, :"what the
            fuck you need to start discounting, your leaving sales on the
            table."
          </p>
          <p className="mt-3">
            I'm over 75% closer ratio with no discounts, I seriously thought he
            was joking. I started to laugh, and said fuck off what do you need,
            in a freindly way. I have only talked to him twice at this point, so
            I dont know how he acts..... He was being serious. The other
            employees were complaing so badly and so often that he had to call
            me, so he can tell them he did something about it. I told him, "Why
            would I devalue your service at the closing ratio im at? Your
            insane, were booking a year from now and people need to get in as
            soon as possible. Why would I discount? We have the best
            service/product and the cheapest rates in the industry, your
            seriously not making any sense. It would be stupid to discount. For
            the next two weeks, I never gave one discount. After the sale I had
            to put in a fake discount just so i wouldnt get fired. By the time I
            had left, everyone stopped discount because I showed them it can be
            done."
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p className="">
            The morning after - or 12 mins after or 22 hours after
          </p>
          <p className="">Communication:</p>
          <p className="">
            {" "}
            Hey Client - First name its User - First name from Freedom, were
            currently closed so I may not be able to answers all your questions
            till we open, but I'll try my best to help you now.
          </p>
          <p className="">Task: </p>
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p className="">Communication:</p>
          <p className="">
            I want to express my gratitude once more for choosing us, Client -
            First name . I hope you find great joy in your Current Vehicle -
            Model for the years ahead. If you ever have questions, encounter any
            issues, or anything else comes to mind, please don't hesitate to
            reach out. I'm here and more than willing to assist. Even if you
            believe it's something minor, I value your feedback to ensure your
            purchase was absolutely perfect.{" "}
          </p>
          <p className="">Task: </p>
          <p className=""></p>
        </>
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p className="">Communication:</p>
          <p className="">
            Hey Client - First name , its User - First name from Freedom H-D,
            wanted to touch base with you to let you know we have a lot of
            customers looking to buy used bikes and at this time we don't much
            in stock. If your looking to trade in let me know and I'll be more
    ...
    {
      subject:
        "Consent - 6 months before consent end or sales person no longer here - task",
      body: (
        <>
          <p className="">Criteria</p>
          <hr />
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p className="">Communication:</p>
          <p className="">
            Hey Client - First Name It was great talking to you about the Wanted
            vehicle - Model you are interested in. If any questions or concerns
            come up let me know and I will be more than happy to address them.
            I'll follow up with you in a couple of days to give you time to
            consider any parts or accessories you would like to add. If you want
            to move forward before I follow up, text or call me and we can lock
            it in for you.
          </p>
          <p className="">Task: </p>
          <p className=""></p>
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p className="">
            Hey Client - First name It was great talking to you about the Wanted
            Vehicle - Model . If any questions come up let me know and I will be
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p className="">Communication:</p>
          <p className="">
            Hey Client - First name I trust you had a smooth experience after
            leaving yesterday. Thank you once again for choosing our services,
            and I sincerely hope you enjoy your new bike to the fullest. If any
            questions or issues arise, please don't hesitate to reach out—I'm
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p className="">Communication:</p>
          <p className="">
            I wanted to remind you about our appointment tomorrow. If, for any
            reason, you can't make it, please let me know, and we can
            reschedule. Otherwise, I'm looking forward to seeing you tomorrow!.
          </p>
          <p className="">Task: </p>
          <p className=""></p>
        </>
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p className="">Communication:</p>
          <p className="">
            I wanted to remind you about your motorcycle pick-up tomorrow. If,
            for any reason, you can't make it, please let me know, and we can
            reschedule. Otherwise, I'm looking handing off your new bike to you
  ...
  let mergedArray = scripts.concat(template);
  mergedArray = mergedArray.concat(script);
  console.log(mergedArray.length, script.length + template.length + scripts.length, 'script and templates length')
  ...
  console.log(subcategories.length, 'script and templates length')
                  ...
                  .map((subItem) => (
                    <Button
                      ...
                      onClick={() => {
                        ...
                        console.log(getMail, subCategory, category, subItem, 'in subitem')
        ...
        <TabsContent value="account">
          <div className="hidden space-y-6 p-10 pb-16 md:block">
            <div className="space-y-0.5">
              <h2 className="text-xl tracking-tight">Scripts</h2>
              <p className="text-muted-foreground">
                A sales person tool chest.
              </p>
            </div>
            <div className="flex flex-col space-y-8 lg:flex-row lg:space-x-12 lg:space-y-0">
              ...
              <div className="flex-1 lg:wmax-w-3xl">
                            ...
                            <div className="">
                              <div className="m-2 mx-auto w-[95%]   hover:border-primary  hover:text-primary active:border-primary">
                                <div className="m-2  items-center justify-between p-2 text-foreground">
                                  <p className='text-[20px]'>{selectedRecord.category} </p>
                                  <div className='flex   text-muted-foreground'>
                                    <p className='text-[16px]'>{selectedRecord.subCat}</p>
                                  </div>
                                  <div className='group flex items-center' >
                                    <p className='mt-5'>{selectedRecord.content}</p>
                                    <div className='flex' >
                                      <Button variant='ghost' size='icon' className="cursor-pointer  opacity-0 transition-opacity group-hover:opacity-100" onClick={() => copyText(selectedRecord.content)} >
                                        {copiedText !== selectedRecord.content && <Copy className=" hover:text-primary" />}
                                        {copiedText === selectedRecord.content && <FaCheck className="hover:text-primary" />}
                                      </Button>
                                    </div>
                                  </div>
                                  ...
                                  <div className='mt-5 flex  items-center justify-between text-[#fff]'>
                                    ...
                                    <Form method='post'>
                                      ...
                                      <ButtonLoading
                                        ...
                                        loadingText="Loading..."
                                        className="w-auto cursor-pointer border-border bg-transparent text-foreground hover:border-primary hover:bg-transparent hover:text-primary"
                                      >
                                        Save As Template
                                      </ButtonLoading>
                                    </Form>
                ...
                <div className='mt-auto gap-3'>
                  <Separator className='w-[95%] border-border bg-border text-border mx-auto my-4' />
                  <p className='text-muted-foreground mt-auto '>Your ability to close increases with the amount of tools at your disposal. A mechanic without a tire iron wouldnt be able to change a tire. So why dont more sales people take better care of their scripts, closes, and such?</p>
                </div>
              </div>
            </div>
          </div>
