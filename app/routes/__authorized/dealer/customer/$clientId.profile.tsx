          ...
          <div className="flex-1 lg:max-w-2xl">
            <Form method='post'>
              ...
              {customerCard.map((item, index) => (
                <div key={index} className="grid w-full max-w-sm items-center gap-1.5 space-y-8">
                  <Label htmlFor="email">  {item.label}</Label>
                  <Input type="email" name={item.name} placeholder={item.label} defaultValue={item.value} />
                </div>
              ))}
              <Popover>
              ...
              <div className="grid w-full max-w-sm items-center gap-1.5 space-y-8">
                <Label htmlFor="email"> Best Time To Contact</Label>
              ...
              <div className="grid w-full max-w-sm items-center gap-1.5 space-y-8">
                <Label htmlFor="email"> Best Type To Contact</Label>
