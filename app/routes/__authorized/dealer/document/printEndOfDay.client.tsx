...
export function PrintButton({ toReceipt }) {
  ...
  async function RunIt() {
    ...
    const inputs = [
      {
        "dateNow": toReceipt.dateNow,
        "dept": toReceipt.dept,
        "subTotal": toReceipt.subTotal,
        "tax": toReceipt.tax,
        "total": toReceipt.total,
        "cashTotal": toReceipt.cashTotal,
        "debitTotal": toReceipt.debitTotal,
        "creditTotal": toReceipt.creditTotal,
        "chequeTotal": toReceipt.chequeTotal,
        "onlineTotal": toReceipt.onlineTotal,
        "eTransferTotal": toReceipt.eTransferTotal,
        "visaTotal": toReceipt.visaTotal,
        "mastercardTotal": toReceipt.mastercardTotal,
        "amexTotal": toReceipt.amexTotal,
        "sales1": toReceipt.sales1,
        "salesTotal1": toReceipt.salesTotal1,
        "sales2": toReceipt.sales2,
        "salesTotal2": toReceipt.salesTotal2,
        "sales3": toReceipt.sales3,
        "salesTotal3": toReceipt.salesTotal3,
        "sales4": toReceipt.sales4,
        "salesTotal4": toReceipt.salesTotal4,
        "sales5": toReceipt.sales5,
        "salesTotal5": toReceipt.salesTotal5,
        "sales6": toReceipt.sales6,
        "salesTotal6": toReceipt.salesTotal6,
        "sales7": toReceipt.sales7,
        "salesTotal7": toReceipt.salesTotal7,
        "sales8": toReceipt.sales8,
        "salesTotal8": toReceipt.salesTotal8,
        "sales9": toReceipt.sales9,
        "salesTotal9": toReceipt.salesTotal9,
        "sales10": toReceipt.sales10,
        "salesTotal10": toReceipt.salesTotal10,
        "sales11": toReceipt.sales11,
        "salesTotal11": toReceipt.salesTotal11,
      }
    ];
