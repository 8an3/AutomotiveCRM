...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  let custData
  if (referer === 'http://localhost:3000/leads/activix' || referer === 'http://localhost:3000/leads/sales' || referer === 'http://localhost:3000/leads/finance') {
        ...
        <div className="mx-auto my-auto mt-[55px] ">
          ...
          <Form method='post' >
            <fieldset disabled={isSubmitting}>
              ...
              <Input type="hidden" name="toStock" defaultValue={toStock} />
