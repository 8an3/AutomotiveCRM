  ...
  return (
    <div className="flex  bg-zinc-100 mx-auto overflow-x-clip">
      <div className="flex flex-col pb-28 w-screen max-md:pb-24 max-md:max-w-full">
        ...
        <p className="mt-10 leading-8 text-center mx-5 text-neutral-900 text-xl">
          If your still unsure, you can request a demo through our <NavLink to='/contact' className='underline' >contact page.</NavLink>
        </p>


        <div id='roadmap' className="max-w-2/3 w-2/3 mx-auto mt-10 text-neutral-900">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mx-auto">
            ...
            <Card className="lg:col-span-2  bg-[#f4f4f5] overflow-y-clip  rounded-[32px] ">
              <CardHeader className='bg-[#f4f4f5] text-neutral-900  rounded-[34px] border-transparent'>
                <CardTitle>Roadmap Items</CardTitle>
              </CardHeader>
              <CardContent className="flex-grow !grow  max-h-[500px] h-full overflow-y-auto  border-b border-t border-border">
              ...
              <CardFooter className='bg-[#f4f4f5] mt-auto flex-col justify-self-end h-[75px] rounded-[32px] border-transparent text-neutral-900'>
                <div className="flex-col font-bold mt-3">
  ...
  return (
    <div className='text-neutral-900 '>
      ...
      <p className='px-[8px]   text-left text-sm    '>
        Q: Don't take my word for it, do the math.
      </p>
      <p className='px-[8px]   text-left text-sm    '>
