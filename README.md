...
In a nut shell, a crm coded by sales professionals, who are still on the sales floor everyday. Started as a project to be a solution for one small problem. That solution worked so much better then anything currently available in the industry, I started to look at what else can be improved. We don't have time to get bogged down by the issues that are in the industry and in every CRM wasting countless hours of every employees time. If the actual person who codes it, NEEDS TO USE IT, the end user experience turns out to be like no other in the industry. If something can be made more effecient, I change it. I don't have the time to waste on stupid tasks that can be helped with tech. Not only seeing the issue or the needed improvement first hand, immediatly on site. I strive to make it a polished experience for each and every role in the dealer. Each role has different process that needs completion every day. We break it down and find a solution where the CRM elegantly helps you complete that process, faster, garaunteed. Saving untold hours of frustration among the staff doing every day menial tasks, but also saving you tons of money in salaries, every year.

Already have a CRM and worried about switching due to the headaches it may cause?
When I was first testing / using the platform, my dealers owners / managment didn't even know I was using a completely different software to complete job duties. To this day, they are completely unaware that I was using a different CRM to sell, manage deals and more. To them, it all looked the same.
...
You don't even need to think about it. Theres nothing but upside to make this change in your career. So you try it and you hate the color of it so much you dont want to use it for that reason?
Great, didn't cost you a dime to find that out.
Because of that, your doing your professional career in sales a diservice by not trying it and witnessing it first hand.
I'll be honest, this was the second idea I had for the project, to reskin the sales dashboard on my CRM. To help me do all the things that have nothing to do with sales, but still need to be done for the job, that every crm seems to ignore trying to help you with. Or worst, the system they have increases the amound of time to do that task. In turn this would allow me to focus on selling more. Every CRM on the market wastes so much of your time. So if your looking for that one change to make in your sales career to boost sales this year, with a 100% garauntee of increasing them because it does not rely on motivation, salesmanship or the secret (If your still looking for it.)... You found it.
One issue came up when I was thinking about this endeavour. Theres not a chance in hell that I can convince the dealer owner to switch to some random crm, a sales guy made. So I took the route to beg for foregivness, not permission. It worked so well, that conversation never came. The data that I inputed into my CRM... looked exactly the same as the dealers CRM. No one was the wiser. I'm going to tell you to get permission first, because naturally in todays age, it will bother people if I don't, they will complain and that wastes my time. I don't want to deal with those people. Ask your owners first... or whatever, before using it. And if you think about complaining, I already have a templated email sitting in my sales templates to send back as a reply.
