...
export async function Inventory() {
  console.log(chalk.yellow("Seeding inventory..."));
  const inventory = [
    {
      "Package #": "",
      "Package $": "",
    ...
    },
    {
      ...
      "Age": "133",
      "Floor Plan Due Date": "2023-09-12",
      "Location": "Showroom",
      "Stocked": true,
    ...
    try {
      await prisma.inventoryMotorcycle.create({
        data: {
          ...
          onOrder: item["On Order"] === true,
          expectedOn: item["Expected On"],
          status: item["Status"],
          ...
          floorPlanDueDate: item["Floor Plan Due Date"],
          location: item["Location"],
          stocked: item["Stocked"] === true,
          stockedDate: item["Stocked Date"],
          isNew: item["New"] === true,
          sold: item["Sold"] === true,
          ...
          registrationExpiry: item["Registration Expiry"],
          ...
          insuranceStartDate: item["Insurance Start Date"],
          insuranceEndDate: item["Insurance End Date"]
        }
      });
    } catch (error) {
  ...
  console.log(chalk.green("Inventory seeding complete."));
}
