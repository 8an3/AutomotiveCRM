...
const SiMetabase = React.forwardRef(function SiMetabase2({ title = "Metabase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
