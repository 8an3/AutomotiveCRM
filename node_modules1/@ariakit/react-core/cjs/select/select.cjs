...
var _ZA4H6SFXcjs = require('../__chunks/ZA4H6SFX.cjs');
require('../__chunks/ISPZN54T.cjs');


var _HVQRVCAScjs = require('../__chunks/HVQRVCAS.cjs');
...
var _QTPUX3NMcjs = require('../__chunks/QTPUX3NM.cjs');
...
var useSelect = _7NAIPZYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      name,
    ...
    const moveOnKeyDownProp = _NREUHWTUcjs.useBooleanEvent.call(void 0, moveOnKeyDown);
    const toggleOnPressProp = _NREUHWTUcjs.useBooleanEvent.call(void 0, toggleOnPress);
    ...
    const children = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
      value,
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ZA4H6SFXcjs.SelectArrow, {})
    ] });
    ...
    props = _6455U47Tcjs.__spreadProps.call(void 0, _6455U47Tcjs.__spreadValues.call(void 0, {
      ...
      ref: _NREUHWTUcjs.useForkRef.call(void 0, store.setSelectElement, props.ref),
      onKeyDown,
      onMouseDown
    });
    props = _OV363CW6cjs.usePopoverDisclosure.call(void 0, _6455U47Tcjs.__spreadValues.call(void 0, { store, toggleOnClick }, props));
    props = _HVQRVCAScjs.useCompositeTypeahead.call(void 0, _6455U47Tcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var Select = _7NAIPZYNcjs.createComponent.call(void 0, (props) => {
