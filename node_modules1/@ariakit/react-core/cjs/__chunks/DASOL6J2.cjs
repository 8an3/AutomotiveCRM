...
function isNativeClick(event) {
  ...
  return _dom.isButton.call(void 0, element) || element.tagName === "SUMMARY" || element.tagName === "INPUT" || element.tagName === "TEXTAREA" || element.tagName === "A" || element.tagName === "SELECT";
}
var useCommand = _7NAIPZYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { clickOnEnter = true, clickOnSpace = true } = _b, props = _6455U47Tcjs.__objRest.call(void 0, _b, ["clickOnEnter", "clickOnSpace"]);
    const ref = _react.useRef.call(void 0, null);
    const tagName = _NREUHWTUcjs.useTagName.call(void 0, ref, props.as);
    ...
    const onKeyDown = _NREUHWTUcjs.useEvent.call(void 0, (event) => {
      ...
      if (isEnter || isSpace) {
        ...
        if (isEnter) {
          if (!nativeClick) {
            event.preventDefault();
            const _a2 = event, { view } = _a2, eventInit = _6455U47Tcjs.__objRest.call(void 0, _a2, ["view"]);
    ...
    const onKeyUp = _NREUHWTUcjs.useEvent.call(void 0, (event) => {
...
var Command = _7NAIPZYNcjs.createComponent.call(void 0, (props) => {
  props = useCommand(props);
  return _7NAIPZYNcjs.createElement.call(void 0, "button", props);
});
