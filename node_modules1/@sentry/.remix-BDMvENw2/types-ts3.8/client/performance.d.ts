...
export declare function startPageloadSpan(): void;
/**
...
export declare function setGlobals({ useEffect, useLocation, useMatches, instrumentNavigation, customStartTransaction, }: {
    useEffect?: UseEffect;
    useLocation?: UseLocation;
    useMatches?: UseMatches;
