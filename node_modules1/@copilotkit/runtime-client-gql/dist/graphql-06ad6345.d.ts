...
declare const GenerateCopilotResponseDocument: TypedDocumentNode<GenerateCopilotResponseMutation, Exact<{
    data: GenerateCopilotResponseInput;
    properties?: InputMaybe<Scalars['JSONObject']['input']>;
}>>;

export { ActionExecutionMessageInput as A, BaseMessageOutput as B, CloudInput as C, ResultMessageOutput as D, Exact as E, FailedMessageStatus as F, GenerateCopilotResponseInput as G, SuccessMessageStatus as H, InputMaybe as I, SuccessResponseStatus as J, TextMessageOutput as K, GenerateCopilotResponseMutationVariables as L, Maybe as M, GenerateCopilotResponseMutation as N, GenerateCopilotResponseDocument as O, PendingMessageStatus as P, Query as Q, ResponseStatus as R, Scalars as S, TextMessageInput as T, MakeOptional as a, MakeMaybe as b, MakeEmpty as c, Incremental as d, ActionExecutionMessageOutput as e, ActionExecutionScope as f, ActionInput as g, BaseResponseStatus as h, CopilotRequestType as i, CopilotResponse as j, FailedResponseStatus as k, FailedResponseStatusReason as l, ForwardedParametersInput as m, FrontendInput as n, GenerateCopilotResponseMetadataInput as o, GuardrailsInput as p, GuardrailsRuleInput as q, MessageInput as r, MessageRole as s, MessageStatus as t, MessageStatusCode as u, Mutation as v, MutationGenerateCopilotResponseArgs as w, PendingResponseStatus as x, ResponseStatusCode as y, ResultMessageInput as z };
